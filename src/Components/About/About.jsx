  ...
  return (
    <div className='about'>
      ...
      <div className="about-right">
        ...
        <p>Embark on a transformative educational journey with our comprehensive education programs. Our cutting-edge curriculum is designed to empower students 
        with the knowledge, skills, and experience needed to excel in the dynamic field of education.</p>
        <p>With a focus on innovation, hands-on learning, and personalized mentorship, our programs
        prepare aspiring educators to make a meaninful impact in classrooms, schools, and communities.
        </p>
